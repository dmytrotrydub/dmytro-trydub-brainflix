...
const VideoDesctiption = (props) => {
  return (
    <div className='description-comments'>
      <p className='description-comments__text'>
      ...
      <p className='description-comments__comments-amount'>3 comments</p>
    </div>
  );
};

export default VideoDesctiption;
